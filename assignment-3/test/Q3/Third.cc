...
void solve_a(std::string prt1, std::string prt2, std::string prt3, std::string conf_num)
{
...
int main(int argc, char *argv[])
{
    ...
    if (conf_num == "1")
    {
        solve_a("TcpNewReno", "TcpNewReno", "TcpNewReno", "1");
    }
    else if (conf_num == "2")
    {
        solve_a("TcpNewReno", "TcpNewRenoCSE", "TcpNewReno", "2");
    }
    else
    {
        solve_a("TcpNewRenoCSE", "TcpNewRenoCSE", "TcpNewRenoCSE", "3");
    }
    // system("cd q3 && gnuplot q3.plt");
}
